...
public final class DeviceUtils {
    ...
    public static String getMacAddress(Context ctx) {
        String macAddress = getMacAddressByWifiInfo(ctx);
    ...
    private static String getMacAddressByWifiInfo(Context ctx) {
        try {
     ...
     */
    public static void reboot(Context ctx, final String reason) {
